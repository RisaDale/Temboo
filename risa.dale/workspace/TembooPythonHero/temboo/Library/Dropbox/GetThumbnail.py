...
class GetThumbnailInputSet(InputSet):
        ...
        """
        Set the value of the ResponseFormat input for this choreography. ((optional, any) The format that the response should be in. Can be set to xml or json. Defaults to xml.)
        """
