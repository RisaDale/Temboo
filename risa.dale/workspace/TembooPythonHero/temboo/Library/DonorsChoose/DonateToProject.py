...
class DonateToProjectInputSet(InputSet):
        """
        Set the value of the APIKey input for this choreography. ((required, string) The APIKey provided by Donor's Choose.)
        """
        def set_APIKey(self, value):
            InputSet._set_input(self, 'APIKey', value)

        """
        Set the value of the APIPassword input for this choreography. ((required, string) This password is required for doing transactions you need to do transactions.)
        """
